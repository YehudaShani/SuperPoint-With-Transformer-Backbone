...
def create_meshgrid(
        height: int,
        width: int,
        normalized_coordinates: np.bool = True,
    ...
    Args:
        ...
        normalized_coordinates (np.bool): whether to normalize
...
def warp_perspective(src: torch.Tensor, M: torch.Tensor, dsize: Tuple[int, int],
                     ...
                     align_corners: Optional[np.bool] = None) -> torch.Tensor:
    ...
    Args:
        ...
        align_corners(np.bool, optional): interpolation flag. Default: None.
